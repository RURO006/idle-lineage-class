    ...
    },
    {
        ...
        gen: function (q) {
            ...
            let flavor = ({
                ...
                royal: '最多可帶 7 名傭兵；魅力不影響傭兵人數，也不增加傭兵能力。',
    ...
    },
    {
        ...
        gen: function () {
            return [
                ...
                '所有職業最多可帶 7 名傭兵；8 格存檔扣除目前角色後，剛好能組成完整傭兵隊伍。',
                '召喚物走另一套，召喚控制戒指可以指定要召什麼，別用預設的。',
                '傭兵攻擊技能如果 MP/HP 不夠或條件不符，現在會回普攻節奏，不會假裝施法成功又吃冷卻卡住。',
                '所有職業都可以帶到 7 名傭兵，場上都會顯示外觀；傭兵吃來源角色的等級、裝備、自動技能與變身能力快照。',
    ...
    },
    {
        ...
        gen: function (q) {
            ...
            let hint = ({
                ...
                royal: '魅力直接決定寵物；傭兵最多可帶 7 名，別忽略隊伍配置。', dragon: '力量體質，龍魔法吃 HP 所以體質更重要。',
