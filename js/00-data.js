...
const GAME_VERSION = 'v3.8.58';   // 🏷️ 版本號：末段 0~99 線性遞增，達 100 進位（中位 +1、末段歸 0）
    ...
    towns: {
		...
		"town_gludin": {
            ...
            npcs: [
                ...
                { id: "npc_austin", n: "奧斯丁", title: "寵物保管", type: "petstore", d: "看慣了碼頭來去的旅人，奧斯丁願替他們照看捕獲的寵物。最多保管 64 隻（同模式角色共通）；可在此讓寵物出戰、鎖定、放生，或讓等級 30 以上「一般型態」的寵物進化——用進化果實→對應高等，或用勝利果實→黃金龍（兩種果實都帶著時可自選）；自己的傭兵攜帶的寵物可直接收回，其他角色未在遊玩時也可直接收回其出戰寵物；正在遊玩的角色與其他角色傭兵租借中的寵物仍需由原本角色處理；高等型態與黃金龍皆為最終型態。" }
            ]
        },
		"town_gludio": {
            n: "燃柳村",
        ...
        "town_aden": {
            ...
            npcs: [
                ...
                { id: "npc_baowu", n: "包武", title: "寵物保管", type: "petstore", d: "和善的看護人包武，願替遠行的旅人照看捕獲的寵物。最多保管 64 隻（同模式角色共通）；可在此讓寵物出戰、鎖定、放生，或讓等級 30 以上「一般型態」的寵物進化——用進化果實→對應高等，或用勝利果實→黃金龍（兩種果實都帶著時可自選）；自己的傭兵攜帶的寵物可直接收回，其他角色未在遊玩時也可直接收回其出戰寵物；正在遊玩的角色與其他角色傭兵租借中的寵物仍需由原本角色處理；高等型態與黃金龍皆為最終型態。" },
